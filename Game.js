class Game {
    ...
    render(colors = ['#a19d9f', '#a19d9f', '#a19d9f'], money = this.wallet.getWalletValue(), result = "", stats = [0, 0, 0], bid = 0, wonMoney = 0) {
        // console.log("gramy!!");
    ...
    startGame() {
        ...
        if (!this.wallet.checkCanPlay(bid)) {
            return alert("You have insufficient funds, or entered value is incorrect!")
        }
